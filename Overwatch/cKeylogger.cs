...
namespace Overwatch
{
    public class cKeylogger : IDisposable
    {
        /// <summary>
        ...
        public cKeylogger()
        {
            ...
            hookedKeyboardCallbackAsync = new KeyboardCallbackAsync(cKeylogger_KeyboardCallbackAsync);
        }
        ...
        void cKeylogger_KeyboardCallbackAsync(InterceptKeys.KeyEvent keyEvent, int vkCode, string character)
        {
            switch (keyEvent)
            {
                // KeyDown events
